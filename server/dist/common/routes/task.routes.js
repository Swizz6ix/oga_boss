 ...
 *     description: some server error
 */
taskRoutes.get('/all', [authenticated.authSession, permission.userActivity(access)], taskController.getAllTasks);
taskRoutes.get('/:taskId', [authenticated.authSession, permission.userActivity(access)], taskController.getTask);
taskRoutes.post('/createTask', [authenticated.authSession, permission.has(role), permission.userActivity(access),
    schemaValidator.verify(taskPayload)], taskController.newTask);
taskRoutes.patch('/update/:taskId', [authenticated.authSession, permission.has(role), permission.userActivity(access),
    schemaValidator.verify(taskUpdatePayload)], taskController.updateTask);
taskRoutes.delete('/delete/:taskId', [authenticated.authSession, permission.has(role)], taskController.deleteTask);

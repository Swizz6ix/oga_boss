...
superUserRoutes.get('/:userId/users', [authenticated.authSession, permission.has(role)], superUserController.getUsers);
superUserRoutes.get('/:userId/departments', [authenticated.authSession, permission.has(role)], superUserController.getDepartments);
superUserRoutes.get('/:userId/totalDepartments', [authenticated.authSession, permission.has(role)], superUserController.getDepartMentsCount);
superUserRoutes.get('/:userId/tasks', [authenticated.authSession, permission.has(role)], superUserController.getTasks);
superUserRoutes.get('/:userId/totalTasks', [authenticated.authSession, permission.has(role)], superUserController.getTasksCount);
superUserRoutes.get('/:userId/totalUsers', [authenticated.authSession, permission.has(role)], superUserController.getUsersCount);

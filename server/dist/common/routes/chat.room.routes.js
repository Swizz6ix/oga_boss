 ...
 *     description: some server error
 */
chatRoomRoutes.get('/all', [authenticated.authSession, permission.userActivity(access)], chatRoomController.getAllMsg);
chatRoomRoutes.get('/:messageId', [authenticated.authSession, permission.userActivity(access)], chatRoomController.getMsg);

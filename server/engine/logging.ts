...
const alertTransport: DailyRotateFile = new DailyRotateFile({
...
const rejections: DailyRotateFile = new DailyRotateFile({
...
const exceptions: DailyRotateFile = new DailyRotateFile({
